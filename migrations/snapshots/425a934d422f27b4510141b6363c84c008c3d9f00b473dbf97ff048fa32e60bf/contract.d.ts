...
export type StorageHash =
  StorageHashBase<'425a934d422f27b4510141b6363c84c008c3d9f00b473dbf97ff048fa32e60bf'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Borrow: {
      ...
      readonly borrowDate: CodecTypes['pg/timestamp-temporal@1']['output'];
      readonly dueDate: CodecTypes['pg/timestamp-temporal@1']['output'];
    ...
    readonly User: {
      ...
      readonly lastActivityDate: CodecTypes['pg/timestamp-temporal@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamp-temporal@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Borrow: {
      ...
      readonly borrowDate: CodecTypes['pg/timestamp-temporal@1']['input'];
      readonly dueDate: CodecTypes['pg/timestamp-temporal@1']['input'];
    ...
    readonly User: {
      ...
      readonly status: 'PENDING' | 'APPROVED' | 'REJECTED';
      readonly role: 'USER' | 'ADMIN';
      readonly lastActivityDate: CodecTypes['pg/timestamp-temporal@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamp-temporal@1']['input'];
    };
  };
};
